...
const output = maxOfTwoNumbers(9, 3);
console.log(output);
...
const average = averageWordLength(words2);
console.log(`The average length of the words is ${average}`);
...
const result = uniquifyArray(words3);
console.log(result);
...
console.log(
  `Does the word "${wordToFind}" exist? ${doesWordExist(wordsFind, wordToFind)}`
);
...
console.log(countRepetitions(wordsCount));
